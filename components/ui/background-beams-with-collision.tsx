...
export const BackgroundBeamsWithCollision = ({
    ...
    return (
        (<div
            ref={parentRef}
            className={cn(
                "h-screen bg-gradient-to-b from-neutral-100 to-white dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden",
                className
            )}>
            {beams.map((beam) => (
                <CollisionMechanism
...
const CollisionMechanism = React.forwardRef(({ parentRef, containerRef, beamOptions = {} }, ref) => {
    ...
    useEffect(() => {
        ...
        const animationInterval = setInterval(checkCollision, 5);
